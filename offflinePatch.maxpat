...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.0, 1054.0, 47.0, 22.0 ],
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 984.5, 111.0, 22.0 ],
					"text" : "expr $f1 * ($f2/100)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 659.0, 1013.300000011920929, 87.0, 22.0 ],
					"text" : "dataToMIDICC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 925.5, 111.0, 22.0 ],
					"text" : "expr $f1 * ($f2/100)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "signal", "" ],
					"patching_rect" : [ 659.0, 954.300000011920929, 87.0, 22.0 ],
					"text" : "dataToMIDICC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 864.0, 111.0, 22.0 ],
					"text" : "expr $f1 * ($f2/100)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "signal", "" ],
					"patching_rect" : [ 659.0, 892.800000011920929, 87.0, 22.0 ],
					"text" : "dataToMIDICC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 805.0, 111.0, 22.0 ],
					"text" : "expr $f1 * ($f2/100)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "signal", "" ],
					"patching_rect" : [ 659.0, 833.800000011920929, 87.0, 22.0 ],
					"text" : "dataToMIDICC"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 203.5, 69.800000011920929, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 188.5, 54.800000011920929, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 48.5, 144.800000011920929, 36.0, 18.0 ],
					"text" : "CC ",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 173.5, 39.800000011920929, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 33.5, 129.800000011920929, 36.0, 18.0 ],
					"text" : "CC ",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.0, 676.800000011920929, 263.0, 98.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.399997532367706, 1123.5, 628.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.899997532367706, 1094.5, 608.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.899997532367706, 1063.0, 56.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.899997532367706, 1161.5, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 472.600008308887482, 464.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.399998486042023, 38.599996566772461, 347.0, 118.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 337.5, 413.199996948242188, 53.0, 22.0 ],
					"text" : "slide 5 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 234.0, 15.39999932050705, 45.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 579.0, 724.0, 63.0, 20.0 ],
					"text" : "PRESIÓN"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 585.0, 621.0, 38.0, 20.0 ],
					"text" : "MQ-4"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 585.0, 513.0, 38.0, 20.0 ],
					"text" : "MQ-3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 685.0, 263.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 574.0, 263.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 304.0, 463.0, 263.0, 98.0 ],
					"setminmax" : [ 40.0, 200.0 ],
					"setstyle" : 3,
					"slidercolor" : [ 0.945098039215686, 0.568627450980392, 0.129411764705882, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 347.0, 484.0, 23.0, 484.0, 23.0, 715.0, 45.899997532367706, 715.0 ],
					"source" : [ "obj-26", 0 ]
				}
